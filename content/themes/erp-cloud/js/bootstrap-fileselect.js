...
(function (window, $) {
    var Fileselect = function (fileInput, options) {
        ...
        this.translations = {
            'en': {
                'browse': 'Seleccionar Archivo(s)',
                'rules': {
                    'numberOfFiles': 'El número maximo de archivos permitidos es [num] archivo(s)',
                    'fileExtensions': 'Solo se permiten los tipos de archivos: [ext]',
                    'fileSize': 'El tamaño por archivo no debe exceder [size]',
                }
            },
            'de': {
                'navega': 'Durchsuchen',
