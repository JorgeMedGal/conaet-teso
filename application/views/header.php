...
<html lang=MX>
  <head>
    ...
    <script src="<?=base_url();?>content/themes/erp-cloud/js/jquery-3.3.1.js"></script>
    ...
    <script src="<?=base_url();?>content/themes/erp-cloud/js/sweetalert.min.js"></script>
    ...
    <link rel="stylesheet" href="<?=base_url();?>content/themes/erp-cloud/css/jquery.mCustomScrollbar.min.css">
    <script src="<?=base_url();?>content/themes/erp-cloud/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="<?=base_url()?>content/themes/erp-cloud/js/Chart.bundle.js"></script>
    <title>AudiTes</title>
